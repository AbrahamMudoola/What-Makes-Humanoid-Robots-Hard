...
```bash
git clone https://github.com/AbrahamMudoola/What-Makes-Humanoid-Robots-Hard.git
cd What-Makes-Humanoid-Robots-Hard
open index.html
```

## Contributing

PRs and issues welcome. A few things that would be useful:

- Keeping the data current as new pilots and research drop
- New deployment contexts or challenge categories
